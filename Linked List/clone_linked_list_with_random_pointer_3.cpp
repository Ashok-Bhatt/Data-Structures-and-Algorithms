...
int main() {
    ...
    // Merging the original linked list and new linked list
    ...
    // Assigning thr random pointers to the elements of new linked list
    ...
    // Separting the merged linked lists to their original state
